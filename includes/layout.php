    ...
    ">
        ...
        <aside class="fixed lg:static inset-y-0 left-0 z-50 w-80 lg:w-64 bg-gray-900 border-r border-gray-800 flex flex-col sidebar-slide lg:translate-x-0" :class="{ 'open': sidebarOpen }">
            ...
            <nav class="flex-1 p-4 space-y-1">
                ...
                $oauthConfigured = (
                    FB_APP_ID !== 'your_facebook_app_id' && FB_APP_SECRET !== 'your_facebook_app_secret' &&
                    TWITTER_API_KEY !== 'your_twitter_api_key' && TWITTER_API_SECRET !== 'your_twitter_api_secret' &&
                    LINKEDIN_CLIENT_ID !== 'your_linkedin_client_id' && LINKEDIN_CLIENT_SECRET !== 'your_linkedin_client_secret'
                );
                ...
                $navItems = [
                    ...
                    ['url' => '/dashboard/wrtr.php', 'label' => 'wrtr', 'icon' => 'M11 4H6a2 2 0 00-2 2v14a2 2 0 002 2h12a2 2 0 002-2v-5M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z', 'hasAiIndicator' => true],
                    ['url' => '/dashboard/ai-suggestions.php', 'label' => 'AI Suggestions', 'icon' => 'M13 10V3L4 14h7v7l9-11h-7z'],
                ...
                // Add OAuth Setup only if not fully configured
                if (!$oauthConfigured) {
                    array_splice($navItems, -1, 0, [
                        ['url' => '/dashboard/oauth-setup.php', 'label' => 'OAuth Setup', 'icon' => 'M8 11V7a4 4 0 118 0m-4 8v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z']
                    ]);
                }
                ...
                >
                    ...
                    <span class="flex items-center">
                        <?= $item['label'] ?>
                        <?php if (isset($item['hasAiIndicator']) && $item['hasAiIndicator']): ?>
                            <sup class="ml-1 text-xs text-purple-400">AI</sup>
                        <?php endif; ?>
                    </span>
                </a>
                <?php endforeach; ?>
        ...
        <nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-gray-900 border-t border-gray-800 z-30 bottom-nav">
            <div class="grid grid-cols-5 gap-1 p-2">
                ...
                >
                    ...
                    <span class="text-xs font-medium relative">
                        <?= $item['label'] ?>
                        <?php if (isset($item['hasAiIndicator']) && $item['hasAiIndicator']): ?>
                            <sup class="absolute -top-1 -right-2 text-purple-400" style="font-size: 0.5rem;">AI</sup>
                        <?php endif; ?>
                    </span>
                </a>
                <?php endforeach; ?>
